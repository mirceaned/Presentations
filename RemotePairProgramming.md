...
- switch to remote during the pandemic
...
- better problem definition, easy to maintain discipline for things like TDD, better code, continuous code reviews, and others 
...
- Screen sharing and control
  - variety of tools: Zoom, TeamViewer, MS Teams, Tuple
  - Tuple follwed by Zoom seems the better solution for remote pairing, but it's not perfect
  - low latency
  - low CPU usage
